...
1. اقرأ `docs/DECISIONS.md` — قرارات مقفلة ملزمة (مصادقة، أدوات↔أقسام، استقبال، طلبات، قاعات).
2. ابدأ الفرع من آخر `main` المحدَّث.
3. لا تُعد إدخال رقم الجوال للدخول، ولا تنقل أيقونة العين عن اليمين (`start-2`)، ولا تُلحق «(حتى تسجيل الخروج)» بنص تذكرني.
4. لا تُظهر أداة الاستقبال لمدير قسم غير مالك لها؛ ولا تُظهر لموظف الاستقبال إنشاء قوائم الحضور أو التقارير.
5. حذف الفروع البعيدة مؤجَّل حتى **وقت النشر** — ذكّر صاحب المنتج حينها (القسم 10 في `docs/DECISIONS.md`).
