      ...
      >
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <input
              id="password"
              className="input-field w-full rounded-lg pe-11 focus:ring-2 focus:ring-primary/20"
            ...
            <button
              type="button"
              className="absolute end-2 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-md text-brand-gray/55 transition-colors hover:bg-surface-muted hover:text-brand-gray focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
